...
plot(guerry_sp, col=sapply(crm_lisa_clusters, function(x){return(lisa_color[[x+1]])}), border = "#333333", lwd=0.2)
title(main = "Local Moran Map")
legend('bottomright', legend = c("Not Sig", "High-High", "Low-Low", "Low-High","High-Low"), fill = lisa_color, border = "#eeeeee")
```
