...
p_betweensumofsquares <- function(solution, data) {
    .Call('_rgeoda_p_betweensumofsquares', PACKAGE = 'rgeoda', solution, data)
}

p_totalsumofsquares <- function(data) {
    .Call('_rgeoda_p_totalsumofsquares', PACKAGE = 'rgeoda', data)
}

p_withinsumofsquares <- function(solution, data) {
    .Call('_rgeoda_p_withinsumofsquares', PACKAGE = 'rgeoda', solution, data)
}
