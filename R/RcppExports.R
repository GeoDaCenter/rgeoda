...
p_skater <- function(k, xp_w, data, n_vars, distance_method, bound_vals, min_bound, seed, cpu_threads) {
    .Call('_rgeoda_p_skater', PACKAGE = 'rgeoda', k, xp_w, data, n_vars, distance_method, bound_vals, min_bound, seed, cpu_threads)
}

p_redcap <- function(k, xp_w, data, n_vars, redcap_method, distance_method, bound_vals, min_bound, seed, cpu_threads) {
    .Call('_rgeoda_p_redcap', PACKAGE = 'rgeoda', k, xp_w, data, n_vars, redcap_method, distance_method, bound_vals, min_bound, seed, cpu_threads)
}

p_schc <- function(k, xp_w, data, n_vars, linkage_method, distance_method, bound_vals, min_bound) {
    .Call('_rgeoda_p_schc', PACKAGE = 'rgeoda', k, xp_w, data, n_vars, linkage_method, distance_method, bound_vals, min_bound)
}

p_maxp_greedy <- function(xp_w, data, n_vars, bound_vals, min_bound, iterations, init_regions, distance_method, seed, cpu_threads) {
    .Call('_rgeoda_p_maxp_greedy', PACKAGE = 'rgeoda', xp_w, data, n_vars, bound_vals, min_bound, iterations, init_regions, distance_method, seed, cpu_threads)
}

p_maxp_sa <- function(xp_w, data, n_vars, bound_vals, min_bound, iterations, cooling_rate, sa_maxit, init_regions, distance_method, seed, cpu_threads) {
    .Call('_rgeoda_p_maxp_sa', PACKAGE = 'rgeoda', xp_w, data, n_vars, bound_vals, min_bound, iterations, cooling_rate, sa_maxit, init_regions, distance_method, seed, cpu_threads)
}

p_maxp_tabu <- function(xp_w, data, n_vars, bound_vals, min_bound, iterations, tabu_length, conv_tabu, init_regions, distance_method, seed, cpu_threads) {
    .Call('_rgeoda_p_maxp_tabu', PACKAGE = 'rgeoda', xp_w, data, n_vars, bound_vals, min_bound, iterations, tabu_length, conv_tabu, init_regions, distance_method, seed, cpu_threads)
}

p_azp_greedy <- function(p, xp_w, data, n_vars, bound_vals, min_bound, inits, init_regions, distance_method, seed) {
    .Call('_rgeoda_p_azp_greedy', PACKAGE = 'rgeoda', p, xp_w, data, n_vars, bound_vals, min_bound, inits, init_regions, distance_method, seed)
}

p_azp_sa <- function(p, xp_w, data, n_vars, cooling_rate, sa_maxit, bound_vals, min_bound, inits, init_regions, distance_method, seed) {
    .Call('_rgeoda_p_azp_sa', PACKAGE = 'rgeoda', p, xp_w, data, n_vars, cooling_rate, sa_maxit, bound_vals, min_bound, inits, init_regions, distance_method, seed)
}

p_azp_tabu <- function(p, xp_w, data, n_vars, tabu_length, conv_tabu, bound_vals, min_bound, inits, init_regions, distance_method, seed) {
    .Call('_rgeoda_p_azp_tabu', PACKAGE = 'rgeoda', p, xp_w, data, n_vars, tabu_length, conv_tabu, bound_vals, min_bound, inits, init_regions, distance_method, seed)
}
