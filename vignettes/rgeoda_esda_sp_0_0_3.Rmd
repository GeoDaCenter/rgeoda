---
title: "ESDA with sp and rgeoda v0.0.3"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{rgeoda_esda_sp_0_0_3}
...
```{block, type='rmdnote'}
Why are we using `as.numeric(as.character(guerry_sp$Crm_prp))`?
